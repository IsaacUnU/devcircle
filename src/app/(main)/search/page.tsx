...
const TRENDING_TAGS = [
  ...
  { name: 'nextjs', count: 870 },
  { name: 'rust', count: 650 },
  { name: 'postgresql', count: 540 },
  { name: 'devops', count: 430 },
  { name: 'opensource', count: 380 },
  { name: 'ai', count: 1100 },
]
  ...
  return (
    <main className="flex-1 max-w-2xl px-6 py-6 border-x border-surface-border min-h-screen">
      ...
      <div className={cn(
        ...
        focused ? 'border-brand-500 bg-surface shadow-lg shadow-brand-500/10' : 'border-surface-border bg-surface-hover'
      )}>
        {loading ? (
                  ...
                  {results.users.map(user => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {user.bio && (
                          <p className="text-sm text-text-secondary mt-1 truncate">{user.bio}</p>
                        )}
                      </div>
